...
const ServerConfigDefaults: Partial<IServerConfig> = {
    ...
    skin_citation_rule_text:
        'Please cite: <a href="http://cancerdiscovery.aacrjournals.org/content/2/5/401.abstract" target="_self">Cerami et al., 2012</a> &amp; <a href="http://www.ncbi.nlm.nih.gov/pubmed/23550210" target="_self">Gao et al., 2013</a>',
