    ...
    var ColumnHider = React.createClass({
        ...
        componentDidMount: function() {
            ...
            $('#hide_column_checklist')
                ...
                .on('change', function() {
                    var list = $('#hide_column_checklist').dropdownCheckbox(
                        'items'
                    );
                    hideColumns(list);
                });
    ...
    var PinColumns = React.createClass({
        ...
        componentDidMount: function() {
            ...
            $('#pin_column_checklist')
                ...
                // Handles dropdown checklist event
                .on('change', function() {
                    var list = $('#pin_column_checklist').dropdownCheckbox(
                        'items'
                    );
                    pinColumns(list);
                });
                    ...
                    this.props.filter === 'GLOBAL' ? (
                        <Filter
                            ...
                            onFilterKeywordChange={
                                this.props.onFilterKeywordChange
                            }
                        ></Filter>
                    ) : null}
            ...
            return (
                <Cell>
                    <a
                        ...
                        onClick={this.props.sortNSet.bind(
                            null,
                ...
                React.createElement(
                    Table,
                    {
                        ...
                        onColumnResizeEndCallback:
                            props.onColumnResizeEndCallback,
                    },
                        ...
                        if (data) {
                            ...
                            switch (measureMethod) {
                                case 'jquery':
                                    ...
                                    break;
                                default:
                                    var upperCaseLength = data.replace(
                                        /[^A-Z]/g,
                                        ''
                                    ).length;
                    ...
                    if (_label) {
                        ...
                        switch (measureMethod) {
                            case 'jquery':
                                ...
                                break;
                            default:
                                var upperCaseLength = _label.replace(
                                    /[^A-Z]/g,
                                    ''
                                ).length;
                        ...
                        if (_labelWidth > columnWidth[attr]) {
                            var end =
                                Math.floor(
                                    (_label.length * columnWidth[attr]) /
                                        _labelWidth
                                ) - 3;
                ...
                if (_label) {
                    ...
                    switch (measureMethod) {
                        case 'jquery':
                            ...
                            break;
                        default:
                            var upperCaseLength = _label.replace(/[^A-Z]/g, '')
                                .length;
                            var dataLength = _label.length;
                            _labelWidth =
                                upperCaseLength * 10 +
                    ...
                    if (_labelWidth > columnWidth[col.name]) {
                        var end =
                            Math.floor(
                                (_label.length * columnWidth[col.name]) /
                                    _labelWidth
                            ) - 3;
        ...
        onFilterKeywordChange: function(e) {
            ...
            var id = setTimeout(function() {
                ...
                if (e.target.getAttribute('data-column') == 'all') {
                    ...
                    filters[e.target.getAttribute('data-column')].key =
                        e.target.value;
                }
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(TableMainPart, {
                        ...
                        onColumnResizeEndCallback: this
                            .onColumnResizeEndCallback,
                    })
                )
            );
